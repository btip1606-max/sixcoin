...
// Copyright (c) 2021-2025 The sixcoin Core developers
...
static UniValue AuxMiningCreateBlock(const CScript& scriptPubKey)
{
     ...
     * a single sixcoind instance, for example when a pool runs multiple sub-
