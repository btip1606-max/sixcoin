...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s sixcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sixcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sixcoin transaction") + "\n" +
              "  sixcoin-tx [options] -create [commands]   " + _("Create hex-encoded sixcoin transaction") + "\n" +
              "\n";
