...
/** Recommended transaction fee by sixcoin Core developers
  *
 ...
 *
 *  sixcoin:    Increment mempool limits and accept RBF in steps of 0.0001 SIX
...
/**
 * sixcoin: Default dust limit that is evaluated when considering whether a
...
/**
 * sixcoin: Default hard dust limit that is evaluated when considering whether
