...
const char * const BITCOIN_CONF_FILENAME = "sixcoin.conf";
const char * const BITCOIN_PID_FILENAME = "sixcoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/sixcoin";
#else
    // Unix
