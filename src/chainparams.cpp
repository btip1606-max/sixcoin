...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in sixcoin v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to sixcoin values
        ...
        //vSeeds.push_back(CDNSSeedData("multiSIX.org", "seed.multiSIX.org", true));
        //vSeeds.push_back(CDNSSeedData("multiSIX.org", "seed2.multiSIX.org"));
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,144); // 0x71
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,111); // 0xc4
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,256); // 0xf1
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x0d)(0x3a)(0xa7)(0xce).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x02)(0x35)(0x93)(0xd4).convert_to_container<std::vector<unsigned char> >();
...
public:
    CRegTestParams() {
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x08)(0x40)(0x23)(0xCD).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x08)(0x35)(0x62)(0x21).convert_to_container<std::vector<unsigned char> >();
    }
