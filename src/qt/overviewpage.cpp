...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the sixcoin Core repository on GitHub"),
        tr("Services that claim to double your sixcoins are always ponzi schemes")
    };
