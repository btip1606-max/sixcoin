#!/usr/bin/env python3
# Copyright (c) 2021-2022 The sixcoin Core developers
...
class P2PPolicyTests(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # a sixcoin Core node that behaves similar to mainnet policies
    ...
    def run_test(self):
        ...
        ### test constants ###
        koinu = Decimal("0.00000001")          # 1 Koinu expressed in SIX
        ten = Decimal("10.0")                  # uniform 10 SIX seed moneys
        ...
        # create a bunch of UTXO with seed money from the sixcoin Core wallet
        for i in range(20):
        ...
        # test legacy output of 1 SIX output and 1 SIX fee
    ...
    # spend seed money with a key not in the sixcoin Core wallet.
    def spend_utxo(self, output, expected_size, retries=0):
        # construct the transaction using sixcoin Core raw tx APIs
        ...
        # and send the tx from there rather than from sixcoin Core, to test
