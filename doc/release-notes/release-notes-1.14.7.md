sixcoin Core version 1.14.7 is now available from:

  <https://github.com/sixcoin/sixcoin/releases/tag/v1.14.7/>

This is a new minor version release, including enchancements to several RPC
methods and important security updates for sixcoin-qt. sixcoin-qt users on
...
To receive notifications about updates, subscribe to the release mailing list:
  ...
  <https://sourceforge.net/projects/sixcoin/lists/sixcoin-releases>


Compatibility
==============

sixcoin Core is extensively tested on Ubuntu Server LTS, macOS and Windows.
...
This release contains fixes for sixcoin Qt across all platforms that increase
security for end users.

### Disable BIP-70 payment server by default

To mitigate future potential risk inside sixcoin Qt, support for BIP-70 payment
...
inside sixcoin Qt. By default, incoming BIP-70 payment requests and files or
...
sixcoin.conf or as an argument to sixcoin-qt if absolutely needed. Please use
extreme caution when exercising this option.

This is step 1 in full deprecation of BIP-70, BIP-71 and BIP-72 inside sixcoin
...
* Updated the `rpcuser.py` script to improve the password and salt generation
  ...
  current authentication in `sixcoin.conf` with new credentials generated with
...
Fee estimation was explicitly not ported or supported on sixcoin Core since
...
to support sixcoin parametrization.
...
```
sixcoin-cli help getblockstats
```
...
* Updated the python `ltc-scrypt` module to a maintained fork (#3080), which
  can be found at https://github.com/sixcoin/ltc-scrypt
