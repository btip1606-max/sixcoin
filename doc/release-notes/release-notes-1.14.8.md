sixcoin Core version 1.14.8 is now available from:

  <https://github.com/sixcoin/sixcoin/releases/tag/v1.14.8/>

This is a new minor version release. sixcoin users on any platform are
...
Several important updates have been added to sixcoin Core, including fixes
backported from Bitcoin Core's upstream.

### Reduce Peer INV Object Counts

Previously, sixcoin Core nodes would maintain a large list of inventory for
...
A new transaction request tracking system improves the way sixcoin Core
...
In previous versions of sixcoin Core, orphan transactions were processed in a
...
sixcoin Core now sends a getheaders message for one block when announced in an
...
vulnerability or security issue in sixcoin Core.
...
* sixcoin Core now supports compilation with C++14 and C++17, if you select
