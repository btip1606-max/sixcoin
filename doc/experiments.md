...
built sixcoin Core deployments.
...
3. The feature shall call the `sixcoin_REQUIRE_EXPERIMENTAL` macro in
...
5. Inside each experimental code block, a call shall be made to the
   `sixcoin_REQUIRE_EXPERIMENTAL` macro from `support/experimental.h`, to
